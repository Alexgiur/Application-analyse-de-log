            ...
            <div class="col-12 col-md-9 col-xl-10 bg-white">
                ...
                <form method="post" action="index.php?modifierLoueur">
                    <table id="modif">
                        ...
                        <tr>
                            <td colspan="3"><input type="password" name="motdepasse" placeholder="Nouveau mot de passe" /></td>
                        </tr>

                        <tr>
                            <td colspan="3"><input type="text" name="pays" placeholder="Nouveau pays" /></td>
                        </tr>

                        <tr>
                            <td colspan="3"><input type="text" name="email" placeholder="Nouvelle adresse email" /></td>
                        </tr>
